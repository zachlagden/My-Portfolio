"""
This isn't my code, I cant remember where I found it but I will add credit if I ever remember.
Credit to the original author!!!
"""

import re

# Define a regular expression pattern to match mobile user agents
reg_b = re.compile(
...
# Define another regular expression pattern to match various mobile device identifiers
reg_v = re.compile(
